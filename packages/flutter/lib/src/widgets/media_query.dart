...
class MediaQueryData {
  ...
  const MediaQueryData({
    ...
    this.lineHeightScaleFactorOverride = 1.0,
    this.letterSpacingOverride = 0.0,
    this.wordSpacingOverride = 0.0,
  ...
  MediaQueryData copyWith({
    ...
    return MediaQueryData(
      ...
      lineHeightScaleFactorOverride: lineHeightScaleFactor ?? this.lineHeightScaleFactorOverride,
      letterSpacingOverride: letterSpacing ?? this.letterSpacingOverride,
      wordSpacingOverride: wordSpacing ?? this.wordSpacingOverride,
  ...
  String toString() {
    final List<String> properties = <String>[
      ...
      'lineHeightScaleFactor: $lineHeightScaleFactorOverride',
